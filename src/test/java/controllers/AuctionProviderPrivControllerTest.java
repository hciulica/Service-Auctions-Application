...
public class AuctionProviderPrivControllerTest extends ApplicationTest {
    ...
    private AuctionProviderPrivController controller;

    @Before
    public void setUp() throws Exception {
        controller= new AuctionProviderPrivController();
    ...
    public void displayAuctions() {
        controller.displayAuctions(TEST_TITLE,TEST_DESCRIPTION);
