...
public class GeneratePrivateAucProvControllerTest  extends ApplicationTest {

    GeneratePrivateAucProvController controller;

    @Before
    public void setUp() throws Exception {
        controller= new GeneratePrivateAucProvController ();
    ...
    public void display() throws Exception
    {
        ...
        Client.generatePrivAuc("titlu", business,"descriere");
        controller.display();
        boolean b=false;
